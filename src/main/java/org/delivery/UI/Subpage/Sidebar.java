...
import org.delivery.UI.Components.ButtonSideBar;
...
public class Sidebar extends JPanel {
    ...
    public void createComponents(boolean isRestaurante) {
        ...
        if (isRestaurante) {
            ...
            buttonMyRestaurant = new ButtonSideBar("Meu restaurante", 0, "src/main/java/org/delivery/Resources/loja.png", 2);
            buttonMyRestaurant.setBackground(new Color(170, 170, 170));

            // Create button for "Exit"
            buttonExit = new ButtonSideBar("Sair", 40, "src/main/java/org/delivery/Resources/logout.png", 4);
            ...
            buttonListRestaurant = new ButtonSideBar("Listar restaurantes", 0, "src/main/java/org/delivery/Resources/lista.png", 0);
            buttonCart = new ButtonSideBar("Carrinho", 40, "src/main/java/org/delivery/Resources/cart.png", 1);
            buttonHistory = new ButtonSideBar("Historico", 80, "src/main/java/org/delivery/Resources/history.png", 3);
            buttonExit = new ButtonSideBar("Sair", 120, "src/main/java/org/delivery/Resources/logout.png", 4);
